                ...
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        ...
	                        <p class="hero-paragraph">Este servidor processa todas as informações utilizadas no aplicativo eMazaGame. Somente usuarios permitidos tem acesso a área restrita neste servidor .</p>
	                        <div class="hero-cta"><a class="button button-primary" href="https://play.google.com/store/apps/details?id=explicador.co.mz" target="_blankl">Baixar App</a><a class="button" href="/admin">Entrar</a></div>
						</div>
					...
					<div class="features-inner section-inner has-bottom-divider">
                        <div class="features-wrap">
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
										<img src=" {{asset('contents/Laravel.svg')}}" alt="Feature 01">
                                    </div>
							...
							<div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
										<img src="{{asset('contents/quasar.png')}}" alt="Feature 02">
                                    </div>
                            ...
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
										<img src="{{asset('contents/GitHub.png')}}" alt="Feature 03">
                                    </div>
                                    <h4 class="feature-title mt-24">Aprenda sobre GitHub</h4>
                                    <p class="text-sm mb-0">Fermentum posuere urna nec tincidunt praesent semper feugiat nibh. A arcu cursus vitae congue mauris. Nam at lectus urna duis convallis. Mauris rhoncus aenean vel elit scelerisque mauris.</p>
                                </div>
                            </div>
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
										<img src="{{asset('contents/java.png')}}" alt="Feature 04" style="width:90px; height:90px" >
                                    </div>
                                    <h4 class="feature-title mt-24">Aprenda Java</h4>
                                    <p class="text-sm mb-0">Fermentum posuere urna nec tincidunt praesent semper feugiat nibh. A arcu cursus vitae congue mauris. Nam at lectus urna duis convallis. Mauris rhoncus aenean vel elit scelerisque mauris.</p>
                                </div>
                            </div>
							<div class="feature text-center is-revealing">
						...
						<div class="pricing-tables-wrap">
                            ...
                            <div class="pricing-table">
                                <div class="pricing-table-inner is-revealing">
                                    <div class="pricing-table-main">
                                        <div class="pricing-table-header pb-24">
                                            <div class="pricing-table-price"><span class="pricing-table-price-currency h2">MT</span><span class="pricing-table-price-amount h1">150</span><span class="text-xs">/Mês</span></div>
                                        </div>
